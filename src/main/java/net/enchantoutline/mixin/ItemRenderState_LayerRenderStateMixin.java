...
public class ItemRenderState_LayerRenderStateMixin {
    ...
    void enchantOutline$renderItemNormal(OrderedRenderCommandQueue instance, MatrixStack matrixStack, ItemDisplayContext itemDisplayContext, int light, int overlay, int outlineColors, int[] tintLayers, List<BakedQuad> quads, RenderLayer renderLayer, ItemRenderState.Glint glintType, Operation<Void> original){
        ...
        ActionResult result = RenderItem.Normal.Callback.EVENT.invoker().renderItem(castLayerRenderState, instance, matrixStack, itemDisplayContext, light, overlay, outlineColors, tintLayers, quads, renderLayer, glintType);
        ...
        if(result != ActionResult.FAIL){
            ...
            RenderItem.Normal.Post.EVENT.invoker().renderItem(castLayerRenderState, instance, matrixStack, itemDisplayContext, light, overlay, outlineColors, tintLayers, quads, renderLayer, glintType);
        }
    }
}
